...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_topN)
       tree position: line 89 of file:///H:/Scale/CLI_log_analyzer/src/main/scala/Analyzer.scala
            tree tpe: <error>
...
== Source file context for tree position ==
    ...
    87       .toList
    88       .sortBy(_._2)
    89       .take(_CURSOR_topN)
    90   }
    91 
    92   def averageResponseSize(entries: List[LogEntry]): Double = {
...
object Analyzer {
  ...
  def topUrls(entries: List[LogEntry], topN: Int): List[(LogEntry, Int)] = {
    entries
      .groupBy(_.url)
      .view
      .mapValues(_.size)
